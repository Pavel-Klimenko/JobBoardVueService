          ...
          <div class="col-lg-4 col-md-4">
            <div class="single_input">
              ...
              <div class="nice-select wide" tabindex="0"><span class="current">City</span>
                <ul class="list">
                  <li data-value="City" class="option selected disabled">City</li>
                  <li data-value="Minsk" class="option">Minsk</li>
                </ul>
              </div>
            </div>
          </div>
          <div class="col-lg-5 col-md-4">
            <div class="single_input">
              ...
              <div class="nice-select wide" tabindex="0"><span class="current">Base technology</span>
                <ul class="list">
                  <li data-value="Base technology" class="option selected disabled">Base technology</li>
                  <li data-value="1" class="option">java</li>
                  <li data-value="12" class="option">swift</li>
                </ul>
              </div>
            </div>
          </div>
