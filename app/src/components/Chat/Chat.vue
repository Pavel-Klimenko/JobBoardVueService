...
<!--            </li>-->
            ...
            <li class="bg-white mb-3">
              <div data-mdb-input-init class="form-outline">
                <textarea v-model="message"  class="form-control bg-body-tertiary" id="textAreaExample2" rows="4"></textarea>
                <label class="form-label" for="textAreaExample2">Message</label>
              </div>
            </li>
            <button @click.prevent="sendMessage"  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-info btn-rounded float-end">Send</button>
          </ul>
